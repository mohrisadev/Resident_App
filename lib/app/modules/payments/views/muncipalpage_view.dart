...
class MuncipalPageView extends GetView<PaymentsController>{
  @override
                          ...
                          Padding(
                              ...
                              child: Align(
                                ...
                                child: TextButton.icon(
                                    ...
                                    label: Text("Pay Muncipal Services",
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext ctxt, int index){
                            return InkWell(
                              ...
                              onTap: (){
                                print("Anita");
                                Get.toNamed(Routes.MUNCIPALCORPORATEVIEW);
