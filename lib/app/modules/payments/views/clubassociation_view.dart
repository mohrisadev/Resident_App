...
class ClubAssociationView extends GetView<PaymentsController>{
  @override
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(" All Club & Association billers"),),
                    Expanded(
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext ctxt, int index){
                            return InkWell(
                              ...
                              onTap: (){
                                print("Anita");
                                Get.toNamed(Routes.CREDITCARDADDVIEW);
                              },
                            );
                          }
                      ),
