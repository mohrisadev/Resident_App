...
class FastTagPageView extends GetView<PaymentsController>{
  @override
                ...
                child: Column(
                  children: <Widget>[
                    Container(
                      ...
                      child: Text("Bank", style: AppConstants.appStyles.nameHead,),
                    ),
                    Container(
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(vertical: 12, horizontal: 4),
                      child: Text("Enter Vehicle number", style: AppConstants.appStyles.nameHead,),
                    ),
                    Container(
                      margin: EdgeInsets.symmetric(vertical: 12, horizontal: 4),
                      decoration: BoxDecoration(color: Colors.white),
                      child: TextField(
                        decoration: InputDecoration(
                          border: OutlineInputBorder(),
                          hintText: 'Vehichle Registation Number',
                          suffix: InkWell(
                            child: Container(
                              height: 30,
                              width: 30,
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(vertical: 12, horizontal: 4),
                      child: Text("Please enter vehile number(Linked to FASTag)Without "
                          "spaces EgKMO908 "),
                    ),
